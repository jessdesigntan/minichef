	...
	mcApp.controller('mainController', function($scope) {
       ...
       window.location = "#/home.html";
		...
		$scope.forgetPasswordEmailSent = false;
		$scope.forgotPassword = function(email) {
			$scope.forgetPasswordEmailSent = true;
			$scope.passwordEmail = "";
	...
	mcApp.controller('profileController', function($scope) {
		...
		$scope.imageSelected = function() {
			//$scope.fileName = $scope.profileImage;
			$scope.fileName = "changed";
		}
	...
	mcApp.controller('cateringController', function($scope) {
	});

	mcApp.controller('checkoutController', function($scope) {
	});

	mcApp.controller('confirmationController', function($scope) {
	});

	mcApp.directive('sliderRange', ['$document',function($document) {
